...
public class SearchFacesExample {
	...
	public static void main(String[] args) throws Exception {
		...
		IndexFacesResult indexFacesResult = callIndexFaces(COLLECTION_ID, amazonRekognition, "samx.jpg");
		callIndexFaces(COLLECTION_ID, amazonRekognition, "sam2.jpg");
		callIndexFaces(COLLECTION_ID, amazonRekognition, "sam1.jpg");
		...
		for(FaceRecord eachfr:fr)
		{
			...
			SearchFacesResult searchFacesResult = callSearchFaces("test2", eachfr.getFace().getFaceId(), threshold, maxFaces,
					amazonRekognition);
