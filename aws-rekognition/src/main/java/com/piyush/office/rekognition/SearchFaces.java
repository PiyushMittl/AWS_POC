...
static String colId=null;
	public List SearchImage(String collectionId,String bucketName,String imageName) {
		colId=collectionId;
...
//		 "No face found"));
		...
		IndexFacesResult indexFacesResult = callIndexFaces(collectionId, amazonRekognition, imageName,bucketName);
		...
		for (String colId : colList) {
			...
			//System.out.println("Faces matching largest face in image  " + imageName);
