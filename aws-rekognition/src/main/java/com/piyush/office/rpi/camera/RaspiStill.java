...
public class RaspiStill
{
   ...
   private final int _picTimeout = 0;
   ...
   public void TakePicture()
   {
      try
      {
        ...
        // sb.append(" -t " + _picTimeout);
         ...
         Runtime.getRuntime().exec("raspistill -w 800 -h 600 -q 100 -e jpg -o test.jpg -t 1");
         System.out.println("raspistill -w 800 -h 600 -q 100 -e jpg -o test.jpg -t 1");
