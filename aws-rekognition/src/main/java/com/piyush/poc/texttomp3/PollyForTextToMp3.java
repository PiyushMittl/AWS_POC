...
public class PollyForTextToMp3 {

	private final AmazonPollyClient polly;
	private final Voice voice;

	AWSCredentials credentials = new BasicAWSCredentials(Constant.accessKey,Constant.secretKey);

	public PollyForTextToMp3(Region region) {
